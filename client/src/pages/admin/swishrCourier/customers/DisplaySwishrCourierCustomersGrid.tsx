...
import {
  Customer,
  useGetSwishrCourierAllCustomersDetails,
} from './hooks/useGetSwishrCourierAllCustomersDetails';
import AppGridRemoteDataFetching from '../../../../components/CoreUI/AppGrids/AppGridRemoteDataFetching';
import MUIThemeProvider from '../../../../providers/MUIThemeProvider';
import { Box } from '@mui/material';
import { swishrCouriercustomersUISchema } from './CRUDUISchema/swishrCouriercustomersUISchema';
import {
  convertIntoDate,
  convertIntoDateTime,
...
const SwishrCourierCustomersDisplay = () => {
    ...
    <MUIThemeProvider>
      <Suspense fallback={<Skeleton height={300} width="100%" />}>
        <AppGridRemoteDataFetching
          ...
          isError={isError}
          tableName={TableNames.SwishrCourierCustomersDisplay}
          crudOperationHeader="Customer"
          columnPinning={{
            left: ['mrt-row-select', 'mrt-row-actions', 'customerId'],
          }}
          uniqueIDForRows="customerId"
          uiSchema={swishrCouriercustomersUISchema}
        />
      </Suspense>
    </MUIThemeProvider>
  );
...
export default SwishrCourierCustomersDisplay;
