...
import { useUploadSwishrCourierCustomersDetails } from './hooks/useUploadSwishrCourierCustomersDetails';
...
const UploadSwishrCourierCustomers: React.FC = () => {
  ...
  } = useUploadSwishrCourierCustomersDetails();
...
export default UploadSwishrCourierCustomers;
